  ...
  <nav class="navbar navbar-dark bg-primary">
    ...
    <div class="col-sm-4">
      <div style="float:right">
        <button class="btn btn-sm btn-success" type="submit" form="add_form" name="save" onclick="document.location='index.php'" style="display: inline-block; margin-right: 10px">SAVE</button>
